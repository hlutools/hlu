...
if(!sw.includes("const BASE='/hlu/';")||!sw.includes("hlu-tools-150926-3-v1"))throw new Error('Service worker chưa lên 150926.3');
...
console.log('HLU TOOLS Web/PWA 150926.3 verification passed: '+required.length+' required files, '+Object.keys(expectedPngDimensions).length+' exact PNG assets.');
